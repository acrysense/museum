...
document.addEventListener('DOMContentLoaded', function () {
  ...
  // years
  var yearsItems = document.querySelectorAll('.years__item');
  function adjustWidths() {
    var container = document.querySelector('.container');
    var containerStyles = window.getComputedStyle(container);
    var containerWidth = container.offsetWidth - parseFloat(containerStyles.paddingLeft) - parseFloat(containerStyles.paddingRight);
    var computedStyles = null;
    var gap = 0;
    if (document.querySelector('.js-content-columns')) {
      computedStyles = window.getComputedStyle(document.querySelector('.js-content-columns'));
      gap = parseFloat(computedStyles.columnGap) || 0;
    }
    var itemWidth = (containerWidth - gap * 4) / 5 / 2;
    if (window.innerWidth >= 1200) {
